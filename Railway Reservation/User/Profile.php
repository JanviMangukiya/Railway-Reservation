...
<body>
    ...
    <div class="contClass">
        ...
        <p style="text-align: center; font-size: 260%; margin-bottom: 4%; color : black;" class="py-3">My Profile</p>

        <!-- Form -->
        <div class="container-fluid py-3" style="margin-left: 27%;">    
        <form action="" method="POST" class="center-section" style="width: 70%; text-align: center; ">
                ...
                <div class="mb-3 row" style="border: 2px;">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="mobile" readonly class="form-control-plaintext" id="mobile" value="<?php echo $passportno ?>" style="border: 2px solid;width: 40%; text-align: center;">
                    </div>
                </div>
                <div class="mb-3 row" style="border: 2px;">
                ...
                <div class="buttons" style="margin-right: 37%;">
                    <button class="btn btn-primary" id="updatebtn" name="updatebtn" style="background-color: #139113; border: 1px solid #139113;">Update Profile</button>
                    <button class="btn btn-primary" id="cancelbtn" name="cancelbtn" style="visibility: none; background-color: #b81414; border: 1px solid #b81414;">Cancel</button>
