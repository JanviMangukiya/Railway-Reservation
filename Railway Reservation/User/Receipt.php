...
<body>
    ...
    <div class='container-fluid' style='border: 1px solid #f3efef; text-align: center; background: #f3efef;'>

        <div class='' style='font-size: 200%; font-weight: 800; padding: 2%;'>Railway Booking Ticket</div>";
...
$html .= "<!-- Ticket Id -->
        ...
        <!-- Passport No -->
        <div class='row' style='padding: 1%;'>
            <span class='col-md-3' style='font-weight: bold;'>Mobile No</span>
            <span class='col-md-3' style='font-weight: bold;'>:</span>
            <span class='' style=''> " . $mobile . "</span>
        </div>
        ...
        <div class=''>For any queries, visit www.Railway.com or make a call to 9316743580</div>
...
$mpdf->WriteHTML($html);
// $pdf = $mpdf->Output();
$pdf = $mpdf->Output("RailwayTicket.pdf",'D');
