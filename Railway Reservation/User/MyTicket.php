...
<body>
    ...
    font-size: 200%;
    text-align: center;
    font-weight: 400;">Show Tickets</div>
                ...
                <tr>
                    ...
                    <td>
                        <a href='Receipt.php?tid=<?php echo $tid; ?>' target="">
                            <button class="btn btn-sm btn-primary mx-2" style="font-weight: bold; background-color: #1658bb;border-color: #1658bb; font-size: 80%">Download Receipt</button>
                        </a>
                        ...
                        <a href="Cancel_Booking.php?tid=<?php echo $tid; ?>">
                            <button style="display: <?php if ($status == 'cancelled') {
                                                            ...
                                                            echo 'inline';
                                                        } ?>;" class="btn btn-sm btn-warning mx-2" style="font-weight: bold; background-color: red;border-color: red; font-size: 80%>Cancel Booking</button>
                        </a>
                    </td>
                    <!-- Status -->
