...
<body>
    <div class="designClassBody">
        ...
        <?php
        $result = mysqli_query($con, "select passengertb.fname, passengertb.bdate, passengertb.mobile, passengertb.email, flighttb.fid, flighttb.fname, flighttb.fsource, flighttb.fdest from passengertb, flighttb where passengertb.pid=" . $_SESSION['pid'] . " and flighttb.fid=" . $_SESSION['fid'] . ";");
        if ($result) {
        ...
        <span class="title" style="padding-top: 3%;">Booking Details</span>
        ...
        margin-bottom: 2%;
        font-size: 118%;'>
            Please Verify all the Details Before Payment...
        </span>";
        } ?>

        <!-- Form to display the passengers details and the flight details they wished to travel through -->
        <form method="POST" class="container" action="" style="margin-top: 2%; margin-left: 20%;">
            <!-- First Name -->
            <div class="field row">
            ...
            <!--Passport No -->
            <div class="field row">
                <span class="col-3">Mobile No.</span>
            ...
            <!-- Flight ID -->
            <div class="field row">
                <span class="col-3">Train ID</span>
                <input class="col-3" type="email" readonly value="<?php echo $data[4]; ?>">
            </div>

            <!-- Flight Name -->
            <div class="field row">
                <span class="col-3">Train Name</span>
            ...
            <!-- Flight Class -->
            <div class="field row">
                <span class="col-3">Available Train Class</span>
            ...
            <div class="" style="color: red; padding-left: 19%;  visibility : <?php echo isset($_POST['btnproceed']) ? "hidden" : "visible"; ?>">
                Please Select Food and Train Class Before Proceeding to Booking.
            </div>

            <!-- Display Amount Payable -->
            <div class="" style="font-size: 110%; color: green; padding-left: 25%; margin-left: 1%; font-weight: 500; visibility : <?php echo isset($_POST['btnproceed']) || isset($_POST['btncheckprice']) ? "visible" : "hidden"; ?>">
            ...
            <div style="display: flex; justify-content: center; margin-top: 3%;">
                ...
                <div class="submit_btn_class">
                    <button type="submit" name="btnproceed" class="btn btn-primary" style="font-weight: bold; background-color: #1658bb;border-color: #1658bb;visibility : <?php echo isset($_POST['btnproceed']) ? "hidden" : "visible"; ?> ">Proceed to Booking</button>
                </div>
                <!-- Check Price button -->
                <div class="submit_btn_class">
                    <button type="submit" name="btncheckprice" class="btn btn-primary" style="font-weight: bold; background-color: #1658bb;border-color: #1658bb;visibility : <?php echo isset($_POST['btnproceed']) ? "hidden" : "visible"; ?>">Check Price</button>
                </div>
            </div>
        </form>
        ...
        <form action="Payment.php" method="POST">
            <!-- Make Payment -->
            <div class="submit_btn_class">
                <button type="submit" name="btnpayment" class="btn btn-primary" style="font-weight: bold; background-color: #1658bb;border-color: #1658bb;visibility : <?php echo isset($_POST['btnproceed']) ? "visible" : "hidden"; ?>">Make Payment</button>
            </div>
        </form>
