...
<body>
    ...
    <!-- Flights -->
    <h2 style="text-align: center; padding: 4%;">Available Trains</h2>
    ...
    <form action="" method="POST" class="container-fluid filter_class">
        ...
        <div class="commom_source_dest">
            ...
            <button id="btnshowall" class="btn btn-sm btn-primary" name="btnshowall" style="font-weight: bold; background-color: #1658bb;border-color: #1658bb;">Show all Train</button>
        </div>
    </form>
