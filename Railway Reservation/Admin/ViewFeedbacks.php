...
<body>
    ...
    <div class="container">
        <div class="right-section">
            <h2 style="text-align: center; padding: 4%">Feedbacks Received</h2>
            ...
            <table class="table my-3">
                ...
                <tbody>
                    ...
                    <div class="" style="display: flex; justify-content: space-between;">
                        ...
                        <a href='delete.php?deleteallfdback'><button class='btn btn-sm btn-primary' style="font-weight: bold; background-color: #1658bb;border-color: #1658bb;">Delete All Feedbacks</button></a>
                    </div>
