...
<body>
    ...
    <div class="container my-3">
        <h2 style="text-align: center; padding: 4%;">Accounts of the Users</h2>
        ...
        <table class="table my-3">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($rows)) {
                    ...
                    <td>$row[5]</td>
                    <td>$row[6]</td>
                    <td><a href='delete.php?id=$row[0]'><button class='btn btn-sm btn-primary' style='font-weight: bold; background-color: #1658bb;border-color: #1658bb;'>Delete Account</button></a></td>
                </tr>";
                }
