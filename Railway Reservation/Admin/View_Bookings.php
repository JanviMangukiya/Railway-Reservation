...
<body>
    ...
    <!-- Title -->
    <h1 style="text-align: center; padding: 4%;">Bookings</h1>

    <!-- Search-Box -->
    <div class="container-fluid">
        Search : <input type="text" placeholder=" Enter Ticket Id, Passenger Id, Train Id" id="search" onkeyup="searchfunc()" style="width: 25%; text-align: center;">
    </div>


    <!-- Show booking details in tabular form -->
    <table class="table" id="table1" style="margin-top: 2%;">
        <thead>
            <tr>
